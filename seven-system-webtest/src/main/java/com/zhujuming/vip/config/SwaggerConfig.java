...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("apply").enable(enableSwagger)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.zhujuming.vip.webtest.controller")).build()
                .globalOperationParameters(pars);
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("seve").description("平台接口文档").termsOfServiceUrl("")
