...
public class Serializer {
    ...
    private static final ObjectMapper mapper_close = new ObjectMapper().disable(SerializationFeature.FAIL_ON_EMPTY_BEANS);
    ...
    public static String SerializeAspectArgs(Object o) {
        if (o == null) {
            return null;
        }
        try {
            return mapper_close.writeValueAsString(o);
        } catch (JsonProcessingException e) {
            log.warn("SerializeAspectArgs error", e);
        }   return "";
    }
