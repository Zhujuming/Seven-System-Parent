package com.zhujuming.vip.webapp.utils;
...
public class JwtTokenBuilder {
    ...
    /**
     * token过期时间，单位：秒。这个值表示1天
     */
    private static final long TOKEN_EXPIRED_TIME = 1 * 24 * 60 * 60;
    ...
    /**
     * 根据userId和password生成token
     */
    public static String generateToken(String password, Integer userId) {
