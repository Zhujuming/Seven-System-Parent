...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("apply").enable(enableSwagger)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.zhujuming.vip.webapp.controller")).build()
                .globalOperationParameters(pars);
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Seven-System-Webapp").description("Seven Web接口文档").termsOfServiceUrl("")
                .contact(new Contact("朱炬明", "", "")).version("1.0").build();
    }
}
